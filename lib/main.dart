      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 18, color: _MainPageState().blendColors(gradientColor1, gradientColor2)),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(color: blendColors(gradientColor1, gradientColor2)),
              ),
            ),
            TextField(
            ...
            Text(
              'Result: $result',
              style: TextStyle(fontSize: 18, color: blendColors(gradientColor1, gradientColor2)),
            ),
          ],
        ),
      ),
